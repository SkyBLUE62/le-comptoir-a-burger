    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                ...
                <form action="{{ url('/addProduit/') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body demo-vertical-spacing demo-only-element">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" aria-label="With textarea" name="description" id="input-description"></textarea>
                        </div>
                        <div class="d-flex">
                            <button type="submit" class="btn rounded-pill btn-dark">Ajouter le produit</button>
                        </div>
                    </div>
                </form>
            </div>
