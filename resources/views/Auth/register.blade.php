...
<body>
    ...
    <main ontouchstart class="with-hover">
        ...
        <section>
            ...
            <form id="form-signup" class="active" method="POST" action="{{ url('/create-account') }}">
                @csrf
                <div>
                    <fieldset>
                        <div>
                            <label for="name">Nom|Prénom</label>
                            <input id="name" name="name" type="text" placeholder="Nom Prénom" />
                        </div>
                    </fieldset>
                    <fieldset>
                        <div>
...
<script src="js/form/registerForm.js"></script>
