        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section">Ajouter une Adresse</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-10">
                        ...
                        <div class="row no-gutters">
                            <div class="col-md-6 d-flex align-items-stretch">
                                <div class="contact-wrap w-100 p-md-5 p-4 py-5">
                                    <h3 class="mb-4">Ajouter une Adresse</h3>
                                    <form method="POST" id="adresseForm" class="contactForm"
                                        action="{{ url('/add-adresse') }}"> @csrf
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" name="pays" id="pays"
                                                        placeholder="France" value="France" readonly
                                                        style="background-color: transparent;">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="submit" value="Ajouter une Adresse"
